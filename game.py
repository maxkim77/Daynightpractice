...
배경이미지_경로 = os.path.join(현재_디렉토리, "img/배경.png")
물고기1_경로 = os.path.join(현재_디렉토리, "img/물고기1.png")
물고기2_경로 = os.path.join(현재_디렉토리, "img/물고기2.png")
스코어바_경로 = os.path.join(현재_디렉토리, "img/스코어바.png")
시간바_경로 = os.path.join(현재_디렉토리, "img/시간-바.png")

배경이미지 = pg.image.load(배경이미지_경로)
물고기1 = pg.image.load(물고기1_경로)
물고기2 = pg.image.load(물고기2_경로)
스코어바 = pg.image.load(스코어바_경로)
시간바 = pg.image.load(시간바_경로)
